...
const ANDROID_STEPS = [
  ...
  {
    step: '3',
    title: 'Search for "StreakBoard"',
    body:  'Scroll through the widget list or search for "StreakBoard". You\'ll find a Small (2×2) and Medium (4×2) size.',
    emoji: '🔍',
  },
  {
    step: '4',
...
const IOS_STEPS = [
  ...
  },
  {
    step: '3',
    title: 'Search for "StreakBoard"',
    body:  'Type "StreakBoard" in the search bar at the top of the widget gallery.',
    emoji: '🔍',
  },
  {
    step: '4',
      ...
      <ScrollView contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={s.hero}>
          ...
          <Text style={[s.heroTitle, { color: colors.textPrimary }]}>
            StreakBoard on your {platform} home screen
          </Text>
        ...
        <View style={[s.previewCard, { backgroundColor: '#0d0d1a' }]}>
          <Text style={s.previewLabel}>🔥 StreakBoard</Text>
